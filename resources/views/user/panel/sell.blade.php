        ...
        <div id="sell-step-1">
            <div class="sell-tutorial-wrap">
                ...
                <p>
                    ...
                    <br>
                    5. در انتها پس از Confirm تراکنش شما و همچنین تایید اپراتور سایت مبلغ مورد نظر به حساب شما واریز خواهد شد.
                </p>
            </div>
            <div class="sell-options">
                ...
                <div class="sell-input">
                    ...
                    <h4>مقدار</h4>
                    <input form="sell_coin" type="text" name="amount" id="amount" placeholder="0.01" onchange="makeExchange()" required>
                </div>
